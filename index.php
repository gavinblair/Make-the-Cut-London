...
<br />
				...
				$questions['revenue-rationalization'] = array(
					'question' => "<br />Vehicle& Equipment Reserve Fund contribution 500k
						...
						<br /><br />			Parking Revenue 38k
						<br />			 new  convenience  fee - paying  tickets  on line, Assumes  25,000 transactions/year  @S1.50/transaction = S37,SO0  new revenue:  Help offset  cost of online service.
						<br /><br />			Vote Passed. 
				...
				$questions['grass-cutting'] = array(
					'question' => "Reduced  grass cutting  along roadsides  will lead to reduced  aesthetics. The City will not look and feel as attractive  to existing  �nd future business  and residents wh�ch  may  impact economic prosperity �nitiatives for a strong economy. This cut rolls back 20%  of the
				...
				$questions['horticultural-features'] = array(
					'question' => "Horticulturalfeatures �n parks  and new  commun�ties  will get less
											...
											reduced  aesthetics  of various  features.  Service  levels for hort�cultural
				...
				$questions['winter-park-garbage-pickup'] = array(
					'question' => "This cut excludes Springbank, Gibbons and Victoria Park.
											...
											w�nter  collect�on.  Survey  of pa rk garbage  in the offseason  f�nds that
											...
											and V�ctoria Park. Some parks may  see  an increase  �n litter that will
				...
				$questions['daytime-arena-closures'] = array(
					'question' => "Close all arenas until 3:30pm, except Nichols & Stronach
											...
											for  daycare  providers.  Closure  will be daily Monday to Fr�day unt�l
											3:30
				...
				$questions['outdoor-aquatics'] = array(
					'question' => "Overall  service  reduction  in outdoor aquatics: Closure  of park  site  wad�ng  pools;
				...
				$questions['snow-control'] = array(
					'question' => "Snow  control  budget  - reduce  2012 growth �nd maintain at 2011  budget - risk to be
				...
				$questions['road-patching'] = array(
					'question' => "Aesthetic service  reduction. This assumes  no capital reduction  in Road
										Rehabilitation.
				...
				$questions['waste-management'] = array(
					'question' => "Growth in 2012 budget for waste management services. 
											Some to medium  impact on the  public  anticip�ted. Sign�ficant
				...
				$questions['downtown-cleaning'] = array(
					'question' => "Eliminate  downtown  clean  up afternoon shift (May - August)
											Aesthetic servlce  reduction.
				...
				$questions['landfill-optimization'] = array(
					'question' => "Planned  optimization  and  efficiency activities  at the W12A  Landfill site
											will reduce  some  of the  need  for overtime.  No impact on the  public
											anticipated
				...
				$questions['in-camera-ii'] = array(
					'question' => "A matter  perta�ning  to labour relations with respect  to employment
											...
											purpose,  and for the  purpose  of providing  instruct�ons and directions to
				...
				$questions['in-camera-iii'] = array(
					'question' => "A matter  pertaining to labour relations and  employee negotiations,
											...
											employees,  with respect  to employment  related-matters,  advice  or
											recommendations  of off�cers and employees  ofthe Corporation
